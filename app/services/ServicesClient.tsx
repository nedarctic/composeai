          ...
          <div className="relative p-10 sm:p-16 rounded-3xl bg-[#E8B85F] shadow-2xl overflow-hidden text-center">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
                <Link
                  href="/contact"
                  className={`${oswald.className} w-full sm:w-auto px-6 sm:px-10 py-4 sm:py-5 bg-[#1C1C30] text-[#E8B85F] text-base sm:text-lg md:text-xl font-bold rounded-full hover:bg-[#1C1C30]/90 hover:scale-105 shadow-2xl transition-all duration-300`}
                >
