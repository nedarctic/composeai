        ...
        <div className="flex flex-col lg:flex-row gap-12">
              ...
              <nav className="space-y-2">
                {[
                  ...
                  <a
                    ...
                    className="block text-sm hover:text-[#daa94e] transition-colors text-gray-700 hover:pl-2 transition-all"
                  >
                    {item}
                  </a>
                ))}
          ...
          <main className="lg:w-3/4 space-y-12">
            ...
            <section className="bg-white p-8 rounded-lg shadow-sm border border-gray-200">
              ...
              <div className="bg-[#f6eddb] border-l-4 border-[#7c5100] p-4 mb-8">
                <p className="text-[#c3933a]">
            ...
            {/* Key Points Summary */}
            <section className="bg-[#f6eddb] p-8 rounded-lg border border-[#E8B85F]">
            ...
            <div className="space-y-12">
              {/* Section 1 */}
              <section id="section-1" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
                  1. WHAT INFORMATION DO WE COLLECT?
                </h2>
                
                <div className="space-y-6">
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">Personal information you disclose to us</h3>
                    <p className="mb-4">
                    ...
                    <p className="font-bold text-gray-700 mb-4">Sensitive Information: We do not process sensitive information.</p>
                  </div>
                  
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">Payment Data</h3>
                    <p className="mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">Information automatically collected</h3>
                    <p className="mb-4">
                    ...
                    <div className="space-y-4 ml-4">
                      <div>
                        <h4 className="font-bold text-gray-800">Log and Usage Data.</h4>
                        <p>
                      ...
                      <div>
                        <h4 className="font-bold text-gray-800">Device Data.</h4>
                        <p>
                      ...
                      <div>
                        <h4 className="font-bold text-gray-800">Location Data.</h4>
                        <p>
              ...
              {/* Section 2 */}
              <section id="section-2" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
                  2. HOW DO WE PROCESS YOUR INFORMATION?
                </h2>
                <p className="mb-6">
              ...
              {/* Section 3 */}
              <section id="section-3" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <div className="space-y-4 ml-4">
                      <div>
                        <h4 className="font-bold text-gray-800">Consent.</h4>
                      ...
                      <div>
                        <h4 className="font-bold text-gray-800">Performance of a Contract.</h4>
                      ...
                      <div>
                        <h4 className="font-bold text-gray-800">Legal Obligations.</h4>
                      ...
                      <div>
                        <h4 className="font-bold text-gray-800">Vital Interests.</h4>
              ...
              {/* Section 4 */}
              <section id="section-4" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
                ...
                <div className="space-y-4 ml-4">
                  <div>
                    <h3 className="font-bold text-gray-800">Business Transfers.</h3>
                  ...
                  <div>
                    <h3 className="font-bold text-gray-800">When we use Google Maps Platform APIs.</h3>
              ...
              {/* Section 5 */}
              <section id="section-5" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
              ...
              {/* Section 6 */}
              <section id="section-6" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
                  6. HOW LONG DO WE KEEP YOUR INFORMATION?
                </h2>
                <p className="mb-4">
              ...
              {/* Section 7 */}
              <section id="section-7" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
                  7. HOW DO WE KEEP YOUR INFORMATION SAFE?
                </h2>
                <p className="mb-4">
              ...
              {/* Section 8 */}
              <section id="section-8" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
                  8. DO WE COLLECT INFORMATION FROM MINORS?
                </h2>
                <p className="mb-4">
              ...
              {/* Section 9 */}
              <section id="section-9" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
                  9. WHAT ARE YOUR PRIVACY RIGHTS?
                </h2>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">Withdrawing your consent:</h3>
                    <p className="mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">Opting out of marketing and promotional communications:</h3>
                    <p className="mb-4">
              ...
              {/* Section 10 */}
              <section id="section-10" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
              ...
              {/* Section 11 */}
              <section id="section-11" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">Categories of Personal Information We Collect</h3>
                    <p className="mb-4">
                        ...
                        <tbody>
                          {[
                            ...
                            <tr key={index}>
                              ...
                              <td className="border border-gray-300 p-2 font-bold">{row[2]}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">Sources of Personal Information</h3>
                    <p>
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">How We Use and Share Personal Information</h3>
                    <p>
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">Will your information be shared with anyone else?</h3>
                    <p className="mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">How to Exercise Your Rights</h3>
                    <p className="mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">Request Verification</h3>
                    <p className="mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">Appeals</h3>
                    <p>
              ...
              {/* Section 12 */}
              <section id="section-12" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
                ...
                <div className="space-y-8">
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">Australia and New Zealand</h3>
                    <p className="mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">Republic of South Africa</h3>
                    <p className="mb-4">
              ...
              {/* Section 13 */}
              <section id="section-13" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
              ...
              {/* Section 14 */}
              <section id="section-14" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
              ...
              {/* Section 15 */}
              <section id="section-15" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
