        ...
        <>
            <section className="relative min-h-screen overflow-hidden">
                ...
                <div className="relative z-10 max-w-5xl mx-auto px-6 pt-[160px] pb-24 flex flex-col items-center">
                    ...
                    >
                        <h1 className={`${oswald.className} text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-6`}>
                            Request Professional Academic, Research & Publication Support
                        </h1>
                        <p className={`${oswald.className} text-lg sm:text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed opacity-90`}>
