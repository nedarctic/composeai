...
export default function TutorialsPage() {
  ...
  return (
    <main className={`${oswald.className} min-h-screen bg-gray-50 text-black`}>
      {/* Background Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-0 w-96 h-96 bg-[#E8B85F]/10 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#E8B85F]/10 rounded-full blur-3xl" />
      </div>

      {/* Hero Section */}
      <section className="relative pt-48 pb-20 px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {subscriptionPlans.map((plan, index) => (
              <motion.div
                ...
                whileHover={{ y: -10 }}
                className={`relative rounded-2xl border-2 ${plan.popular ? 'border-[#E8B85F]' : 'border-gray-200'} bg-white p-6 shadow-lg hover:shadow-xl transition-all`}
              >
                {plan.popular && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {trainingCategories.map((category, index) => (
              ...
              >
                ...
                <div className="mt-4 text-[#E8B85F] font-medium flex items-center">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-600">Live Sessions Monthly</div>
            </div>
            <div className="text-center">
      ...
      {/* Final CTA */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-[#E8B85F]/10 to-[#E8B85F]/5">
