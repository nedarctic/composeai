                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <aside className="lg:w-1/4">
                        <div className="sticky top-8 bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                            ...
                            <h3 className="font-bold text-gray-800 mt-4 mb-2">Refund Policy</h3>
                    ...
                    <main className="lg:w-3/4 space-y-12">
                        ...
                        <div className="space-y-12">
                            {/* Refund Section 1 */}
                            <section id="refund-section-1" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                            ...
                            {/* Refund Section 2 */}
                            <section id="refund-section-2" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
                                    2. Eligibility for Refunds
                                </h2>
                                <div className="space-y-4">
                            ...
                            {/* Refund Section 3 */}
                            <section id="refund-section-3" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
                                    3. Non-Refundable Situations
                                </h2>
                                <div className="space-y-4">
                            ...
                            {/* Refund Section 4 */}
                            <section id="refund-section-4" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
                                    4. Partial Refunds
                                </h2>
                                <div className="space-y-4">
                            ...
                            {/* Refund Section 5 */}
                            <section id="refund-section-5" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
                                    5. Publication Processing Services
                                </h2>
                                <div className="space-y-4">
                            ...
                            {/* Refund Section 6 */}
                            <section id="refund-section-6" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
                                    6. Refund Request Procedure
                                </h2>
                                <div className="space-y-4">
                            ...
                            {/* Refund Section 7 */}
                            <section id="refund-section-7" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
                                    7. Refund Processing Timeline
                                </h2>
                                <div className="space-y-4">
                            ...
                            {/* Refund Section 8 */}
                            <section id="refund-section-8" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                                <h2 className="text-3xl font-bold text-[#E8B85F] mb-6 border-b pb-2">
                                    8. Policy Updates
                                </h2>
                                <div className="space-y-4">
