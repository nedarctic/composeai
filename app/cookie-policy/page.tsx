...
export default function CookiePolicy() {
  return (
    <div className={`${oswald.className} py-20 min-h-screen bg-gray-50 text-black`}>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
              ...
              <nav className="space-y-2">
                {[
                  ...
                  <a
                    ...
                    className="block text-sm hover:text-[#E8B85F] transition-colors text-gray-700 hover:pl-2 transition-all"
                  >
                    {item}
                  </a>
                ))}
          ...
          <main className="lg:w-3/4 space-y-12">
            ...
            <section className="bg-white p-8 rounded-lg shadow-sm border border-gray-200">
              ...
              <div className="bg-yellow-50 border-l-4 border-[#E8B85F] p-4">
            ...
            <div className="space-y-12">
              ...
              <section id="section-1" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded border mt-4">
                    <h3 className="font-bold text-gray-800 mb-2">Why do we use cookies?</h3>
                    <p>
              ...
              <section id="section-2" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">Specific Examples of Cookie Usage</h3>
              ...
              <section id="section-3" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                ...
                <div className="space-y-6">
                    ...
                    <table className="min-w-full border-collapse border border-gray-300">
                      <thead>
                        <tr className="bg-gray-100">
                          <th className="border border-gray-300 p-3 text-left text-gray-800">Category of Cookies</th>
                          <th className="border border-gray-300 p-3 text-left text-gray-800">Purpose</th>
                          <th className="border border-gray-300 p-3 text-left text-gray-800">Examples</th>
                          <th className="border border-gray-300 p-3 text-left text-gray-800">Duration</th>
                        </tr>
                      </thead>
                      <tbody>
                        {/* Essential Cookies */}
                  ...
                  <div className="bg-blue-50 p-4 rounded border mt-4">
                    <h3 className="font-bold text-gray-800 mb-2">About Third-Party Cookies</h3>
                    <p>
              ...
              <section id="section-4" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">Browser Controls</h3>
                    <p className="mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">Cookie Consent Banner</h3>
                    <p className="mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">Third-Party Opt-Outs</h3>
                    <p className="mb-4">
                  ...
                  <div className="bg-yellow-50 p-4 rounded border">
                    <h3 className="font-bold text-gray-800 mb-2">Important Note About Essential Cookies</h3>
                    <p>
              ...
              <section id="section-5" className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 scroll-mt-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded border mt-4">
                    <h3 className="font-bold text-gray-800 mb-2">Your Continued Use</h3>
                    <p>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <a href="/privacy-policy" className="bg-gray-50 p-4 rounded border hover:border-[#E8B85F] transition-colors group">
                        <h4 className="font-bold text-gray-800 group-hover:text-[#E8B85F] mb-2">Privacy Policy</h4>
                        <p className="text-sm text-gray-600">Learn about how we collect, use, and protect your personal information.</p>
                      </a>
                      
                      <a href="/terms-of-service" className="bg-gray-50 p-4 rounded border hover:border-[#E8B85F] transition-colors group">
                        <h4 className="font-bold text-gray-800 group-hover:text-[#E8B85F] mb-2">Terms of Service</h4>
                        <p className="text-sm text-gray-600">Review the terms and conditions governing your use of our services.</p>
                      </a>
                    </div>
                  </div>
                  
                  <div className="bg-blue-50 p-4 rounded border">
                    <h3 className="font-bold text-gray-800 mb-2">Additional Resources</h3>
                    <p className="mb-2">
